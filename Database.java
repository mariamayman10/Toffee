...
import java.util.*;
/**
 * Database class  that contains several methods for handling data related to customer accounts, orders, and product catalog
 */
public class Database {
    Scanner in = new Scanner(System.in);

    /**
     *this function will validate the user info when he is trying to sign up and will send an OTP to his emil for verification
     * @param Name
     * @param Email
     * @param Pass
     * @param Add
    ...
    /**
     * this function will put the items the user choosed in the not delivered orders file
     * @param order
     * @throws IOException
     */
    ...
    /**
     *will update the catalog with the products quantity every time an order is made
     * @param P
     * @param Q
     * @return
     */
    ...
    /**
     * when the order due date comes this function will remove the order from not delivered orders file to delivered orders
     * @param Date
     * @throws IOException
     */
    ...
    /**
     * this function will be called when a user is trying to log in to check if he has account or not
     * @param Email
     * @param Pass
     * @return
     */
    ...
    /**
     * this function is used to change the user's password if the wants
     * @param Email
     * @param NPass
     */
    ...
    /**
     *used to search for an order in the catalog
     * @param productId
     * @return
     */
